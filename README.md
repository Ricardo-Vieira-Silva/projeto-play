...
![Imagem site resposivo](/img/responsivo.png)


**Curso Alura: CSS - Flexbox e Layouts Responsivos**

Este repositório contém os projetos e exercícios desenvolvidos durante o curso de CSS - Flexbox e Layouts Responsivos da Alura.

**Sobre o Curso**
Neste curso da Alura, explorei as técnicas  de CSS para criar layouts flexíveis e responsivos utilizando o poderoso modelo de layout flexbox. Aprenda como criar designs modernos e adaptáveis para qualquer dispositivo, desde desktops até smartphones e tablet.

**Conteúdo do Curso**
Introdução ao Flexbox
Entendendo os eixos principais do Flexbox
Criando layouts flexíveis com Flexbox
Layouts responsivos com Flexbox
Práticas com Flexbox


**Contribuição**
Contribuições são bem-vindas! Se você encontrar um problema ou tiver sugestões para melhorar este curso, sinta-se à vontade para abrir uma issue ou enviar um pull request.

[Ricardo Vieira](https://www.linkedin.com/in/ricardo-vieira-da-silva-7a972922a)
